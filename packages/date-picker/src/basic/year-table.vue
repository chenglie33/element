...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'ttelem/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'ttelem/src/utils/util';
