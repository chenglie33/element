...
/* harmony default export */ var table_column = ({
  ...
  methods: {
    ...
    registerNormalWatchers: function registerNormalWatchers() {
      ...
      var props = ['label', 'property', 'filters', 'filterMultiple', 'sortable', 'index', 'formatter', 'className', 'labelClassName', 'showOverflowTooltip', 'drapAble'];
      // 一些属性具有别名
      var aliases = {
        prop: 'property',
        realAlign: 'align',
  ...
  created: function created() {
    ...
    var basicProps = ['columnKey', 'label', 'className', 'labelClassName', 'type', 'renderHeader', 'formatter', 'fixed', 'resizable', 'dragAble'];
